...
<div class="content-area">
	<main>
			...
			if ( class_exists( 'WooCommerce' ) ):
				...
				<section class="new-arrivals">
					<div class="container">
						...
						<?php echo do_shortcode( '[bs-product-slider order="DESC" orderby="date" posts="12" category="pozadi"]' ); ?>
					</div>
				</section>
									...
									<div class="row d-flex align-items-center">
										...
										<div class="deal-desc col-md-6 col-12 mr-auto text-center">
											...
											<a href="<?php echo esc_url( '?add-to-cart=' . $deal ); ?>"
											   class="add-to-cart"><?php esc_html_e( 'Add to Cart', 'retrygames' ) ?></a>
										</div>
									</div>
								</div>
						</div>
				...
				<div class="container">
				<section class="slider mt-4 mb-4 co-12">
		...
		<section class="lab-blog">
			<div class="container card p-4 mt-4 mb-4">
				<div class="section-title">
