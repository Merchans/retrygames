...
<div id="comments" class="comments-area">
	...
	<?php
		...
		if ( have_comments() ) : ?>
			...
			<h2 class="comments-title mt-4 p-4 card">
				<?php
	...
	<?php comment_form( $args = array(
		...
		'title_reply_before'       => '<div class="mb-4 mt-4 p-4 bg-light rounded"><h3 class="comments-title">',  // that's the wordpress default value! delete it or edit it ;)
		'title_reply_after'       => '</h2></div>',  // that's the wordpress default value! delete it or edit it ;)
		...
		'logged_in_as'       => '',
		'must_log_in'          => '<p class="woocommerce-mini-cart__empty-message alert alert-info">' . sprintf( __( 'You must be <a href="%s">logged in</a> to post a comment.' ), wp_login_url( apply_filters( 'the_permalink', get_permalink( $post_id ) ) ) ) . '</p>',
